...
function Shows() {
  ...
  return (
    <>
      <div className="dcontainer show_bg">
                ...
                <div className="achievement-section-container2">
                  <div className="content-left">
                    ...
                    <p className="medium-text">
                      ...
                      <b>
                        {" "}
                        prestigious National Entrepreneurship Challenge 2023
                      </b>
                      . This national recognition solidifies E-Cell's position
                      as a leading force in shaping the future of
                      entrepreneurship, not just regionally, but nationwide.
                    </p>
                  </div>
                ...
                <div className="achievement-section-container2">
                  <div className="content-left">
                    ...
                    <p className="medium-text">
                      ...
                      influence, ultimately impacting a wider network of
                      aspiring entrepreneurs. By joining forces with these
                      like-minded institutions, E-Cell creates a collaborative
                      environment where knowledge, resources, and opportunities
                      seamlessly flow, fostering an even more vibrant ecosystem.
                    </p>
                  </div>
                  <div className="content-right">
                ...
                <div className="achievement-section-container2">
                  <div className="content-left">
                    ...
                    <p className="medium-text">
                      ...
                      <b>
                        {" "}
                        Funding It Funny, Heaven Threads, Figma Workshop,
                        LinkedIn Workshop, Market Analysis Workshop, and Visual
                        Walk
                      </b>
                      , the E-Cell calendar has been bursting with exciting
                      opportunities. These events equip participants with
              ...
              <div>
                <div className="achievement-section-container2">
                  <div className="content-left">
                    ...
                    <h2 className="blue-text">
                      Offline Visits to multiple startup organizations and
                      more..
                    </h2>
                    <p className="medium-text">
                      Understanding the importance of practical experience,
                      E-Cell organized insightful offline visits to{" "}
                      <b>
                        {" "}
                      ...
                      entrepreneurial journeys firsthand. Such exposure serves
                      as a valuable stepping stone, bridging the gap between
              ...
              <div>
                <div className="achievement-section-container2">
                  <div className="content-left">
                    ...
                    <p className="medium-text">
                      Our team's intellectual agility and entrepreneurial
                      prowess were on full display as we clinched the
                      State-Level Innovation and Entrepreneurship Jeopardy
                      competition. This victory is a testament to our members'
                      dedication to innovation and their sharp understanding of
                ...
                <div className="achievement-section-container2">
                  <div className="content-left">
                    ...
                    <p className="medium-text">
                      ...
                      <b>Mr. Sandeep Jain </b> , founder of GFG and owner of
                      Jain Shikanji, and <b> Mr. Anubhav Jain </b>, who shared
                      their entrepreneurial journeys and valuable insights with
                      our members. These interactions provided invaluable
                      guidance and fueled the aspirations of budding
                      entrepreneurs.
                    </p>
                  </div>
                  <div className="content-right">
